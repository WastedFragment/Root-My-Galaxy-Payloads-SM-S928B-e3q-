...
#define BUILD_VARIANT_LABEL "e3q-S928BXXS4BYG3-app-fops6000-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "e3q-S928BXXS4BYG3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/e3qxxx/e3q:15/AP3A.240905.015.A2/S928BXXS4BYG3:user/release-keys"
#endif
...
#define P0_PHYS_OFFSET 0x80000000ULL
    ...
    !defined(APP_S928_STABLE_RACE_8008)
...
#define SELINUX_ENFORCING_AVAILABLE 0
#define SLIDE_TRACEFS_EVENT_ID 106
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000dd03cULL
...
#define FOPS_S928_TASK_OFF_CANDIDATES 0x6000, 0x7000, 0x1000
...
#define SLIDE_S928_PROBE_TARGET_IMAGE_OFF 0x022beea8ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/e3q-S928BXXS4BYG3/p0_fingerprint.h"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x022beea8ULL
#define ASHMEM_FOPS_OFF 0x0134bc98ULL
#define ASHMEM_IOCTL_OFF 0x00cd5a68ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00cd6350ULL
#define ASHMEM_MMAP_OFF 0x00cd63a8ULL
#define ASHMEM_OPEN_OFF 0x00cd65d4ULL
#define ASHMEM_RELEASE_OFF 0x00cd665cULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00cd677cULL
#define CONFIGFS_READ_ITER_OFF 0x0046d6e0ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046dc10ULL
#define COPY_SPLICE_READ_OFF 0x003ec12cULL
#define NOOP_LLSEEK_OFF 0x0039e594ULL
#define INIT_TASK_OFF 0x0215f040ULL
#define ROOT_TASK_GROUP_OFF 0x0227a1c8ULL
#define KMALLOC_CACHES_OFF 0x016ba938ULL
#define ANON_PIPE_BUF_OPS_OFF 0x011a4490ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d58f4ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0224ae60ULL
...
#define SLIDE_NFULNL_LOGGER_OFF 0x01605b59ULL
#define SLIDE_LOGGERS_0_1_OFF 0x02152a18ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF 0x0227a2d0ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x024c2628ULL
